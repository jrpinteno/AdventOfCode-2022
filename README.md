...
the idea of using a `hashmap` and check for maximum occurrence, but I disregarded it and went with a set. Then for the second part I decided to bring
back my first idea. The algorithm might not be pretty, neither am I. Might come back to it later on.
